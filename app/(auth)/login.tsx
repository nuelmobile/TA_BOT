  ...
  return (
    ...
    <StatusBar barStyle="light-content" backgroundColor='#020105ff' />
     ...
     <View>
          ...
          <Text style={{textAlign: 'center', fontSize: 14, fontWeight:'bold', color: '#0b889bff', marginTop:5}}>Login to your account</Text>        
     </View>
      ...
      <View>
        ...
        style={{borderRadius: 16, borderRightWidth: 2,
          ...
          <Link href = '/forget_password' style={{textAlign: 'center', fontSize: 12, color: '#0b889bff', marginLeft: 10, fontWeight:'bold', marginBottom: 20,}}> 
          Forgot password?      
          </Link>                 
        </TouchableOpacity> 
       ...
       <View>
        ...
        <TouchableOpacity>
          <Link href = '/signup' style={{textAlign: 'center', fontSize: 12, color: '#0b889bff', fontWeight:'bold'}}> 
          Sign up instead       
          </Link>                 
        </TouchableOpacity> 
     </View>
