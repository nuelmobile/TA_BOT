...
const index = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <MaterialCommunityIcons name="robot-outline" size={150} color='#0b889bff' style={styles.icon} />
     ...
     Powered by AI
      ...
      <Text style={styles.subText}>
        Leverage advanced AI driven market analysis to make trading decisions.
      </Text>
